...
2. Write your copy of your GPG public key stored in your password manager to disk (e.g., to `/path/to/pubkey.asc`).
3. Import your public key to GPG: `gpg --import /path/to/pubkey.asc`
4. Get the Yubikey GPG key ID by running `gpg --list-keys`, in the following example the key ID is `4E09860E71D948019BD426D5D099A306DBECDF1B`  
